...
from orbitclaw.cli import commands
...
def mock_prompt_session():
    ...
    with patch("orbitclaw.cli.commands._PROMPT_SESSION", mock_session), \
         patch("orbitclaw.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("orbitclaw.cli.commands.PromptSession") as mock_session_cls, \
         patch("orbitclaw.cli.commands.FileHistory"), \
