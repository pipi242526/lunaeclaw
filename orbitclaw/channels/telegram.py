...
from orbitclaw.utils.helpers import safe_filename
    ...
    async def _on_message(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        if media_file and self._app:
            try:
                ...
                from orbitclaw.utils.helpers import get_media_dir
                ...
                if media_type == "voice" or media_type == "audio":
                    from orbitclaw.providers.transcription import GroqTranscriptionProvider
