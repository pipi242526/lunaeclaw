...
<div class="split">
  ...
  <section class="card">
    ...
    <div class="muted">{t("Auto-apply is guaranteed only when WebUI and gateway share the same ORBITCLAW_DATA_DIR and gateway is alive.", "仅当 WebUI 与 gateway 使用同一个 ORBITCLAW_DATA_DIR 且 gateway 在线时，才能保证自动生效。")}</div>
  </section>
</div>
