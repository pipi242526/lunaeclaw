...
from orbitclaw.agent.subagent import SubagentManager
from orbitclaw.agent.tooling import (
...
from orbitclaw.agent.tools.web import (
    has_exa_search_mcp,
)
...
from orbitclaw.providers.base import LLMProvider
from orbitclaw.session.manager import Session, SessionManager

if TYPE_CHECKING:
    from orbitclaw.config.schema import ClaudeCodeToolConfig, ExecToolConfig
...
class AgentLoop:
    ...
    def __init__(
        ...
        from orbitclaw.config.schema import ExecToolConfig
        self.bus = bus
    ...
    async def _connect_mcp(self) -> None:
        ...
        from orbitclaw.agent.tools.mcp import connect_mcp_servers
        try:
