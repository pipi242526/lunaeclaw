...
def run_status(console: Any, logo: str) -> None:
    ...
    from orbitclaw.agent.tools.web import has_exa_search_mcp
    from orbitclaw.config.loader import _discover_env_files, get_config_path, load_config
...
def run_doctor(console: Any, logo: str) -> None:
    ...
    from orbitclaw.agent.skills import SkillsLoader
    from orbitclaw.config.loader import _discover_env_files, get_config_path, load_config
    from orbitclaw.utils.budget import collect_runtime_budget_alerts, read_host_resource_snapshot
    from orbitclaw.utils.helpers import (
        get_env_dir,
        get_env_file,
        get_exports_dir,
        ...
        if ep_cfg:
            ...
            if ep_cfg.api_key and "${" in str(ep_cfg.api_key):
                findings.append((
                    ...
                    "Check ~/.orbitclaw/.env or ~/.orbitclaw/env/*.env and ensure the referenced variable exists.",
                ))
